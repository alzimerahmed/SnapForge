...
data class SettingsState(
    ...
    val initialOcrEngine: Int,
    val initialPaddleOcrModel: Int,
    ...
    companion object {
        val Default by lazy {
            SettingsState(
                ...
                cacheAutoClearLimitBytes = 20L * 1024 * 1024,
                cacheAutoClearInterval = CacheAutoClearInterval.OnAppLaunch,
                lastCacheAutoClearTimestampMillis = 0L,
                showUpdateDialogOnStartup = !Flavor.isFoss(),
                groupOptionsByTypes = true,
                showFavoriteToolsInGroupedMode = false,
                showFavoriteAsLast = false,
                ...
                cropOverlayDraggable = true,
                drawBitmapBorder = true,
                ...
                favoriteGradients = emptyList(),
                recentGradients = emptyList(),
