...
- Let the configuration cache + up-to-date checks do their job; don't re-run green tasks.
- If a build must run long, run it in the background and poll, keeping the machine responsive.
