...
internal val CUSTOM_ASPECT_RATIOS = stringPreferencesKey("CUSTOM_ASPECT_RATIOS")
...
internal val CROP_OVERLAY_DRAGGABLE = booleanPreferencesKey("CROP_OVERLAY_DRAGGABLE")
...
internal val RECENT_GRADIENTS = stringPreferencesKey("RECENT_GRADIENTS")
internal val FAVORITE_GRADIENTS = stringPreferencesKey("FAVORITE_GRADIENTS")
...
internal val MARKUP_LAYER_TEXT_DEFAULTS = stringPreferencesKey("MARKUP_LAYER_TEXT_DEFAULTS")
...
internal val RAW_USE_EMBEDDED_PREVIEW = booleanPreferencesKey("RAW_USE_EMBEDDED_PREVIEW")
internal val WATERMARK_PRESETS = stringPreferencesKey("WATERMARK_PRESETS")
